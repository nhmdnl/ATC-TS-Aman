...
export const AIRCRAFT_TYPES: ReadonlyArray<AircraftType> = [
  {
    icao: 'B738', name: 'Boeing 737-800', category: 'M', approachCategory: 'C', wakeCategory: Wake.MEDIUM, aircraftClass: 'MEDIUM', rotorcraft: false,
  ...
  {
    icao: 'A320', name: 'Airbus A320', category: 'M', approachCategory: 'C', wakeCategory: Wake.MEDIUM, aircraftClass: 'MEDIUM', rotorcraft: false,
  ...
  {
    icao: 'CRJ9', name: 'Bombardier CRJ-900', category: 'M', approachCategory: 'C', wakeCategory: Wake.MEDIUM, aircraftClass: 'MEDIUM', rotorcraft: false,
  ...
  {
    icao: 'E175', name: 'Embraer E175', category: 'M', approachCategory: 'C', wakeCategory: Wake.MEDIUM, aircraftClass: 'MEDIUM', rotorcraft: false,
  ...
  {
    icao: 'B772', name: 'Boeing 777-200', category: 'H', approachCategory: 'D', wakeCategory: Wake.HEAVY, aircraftClass: 'HEAVY', rotorcraft: false,
  ...
  {
    icao: 'B744', name: 'Boeing 747-400', category: 'H', approachCategory: 'D', wakeCategory: Wake.HEAVY, aircraftClass: 'HEAVY', rotorcraft: false,
  ...
  {
    icao: 'A388', name: 'Airbus A380-800', category: 'J', approachCategory: 'D', wakeCategory: Wake.SUPER_HEAVY, aircraftClass: 'SUPER_HEAVY', rotorcraft: false,
  ...
  {
    icao: 'C172', name: 'Cessna 172 Skyhawk', category: 'L', approachCategory: 'C', wakeCategory: Wake.LIGHT, aircraftClass: 'LIGHT', rotorcraft: false,
  ...
  {
    icao: 'BE20', name: 'Beechcraft King Air 200', category: 'L', approachCategory: 'C', wakeCategory: Wake.LIGHT, aircraftClass: 'LIGHT', rotorcraft: false,
  ...
  {
    icao: 'C130', name: 'Lockheed C-130 Hercules', category: 'H', approachCategory: 'C', wakeCategory: Wake.HEAVY, aircraftClass: 'MILITARY', rotorcraft: false,
  ...
  {
    icao: 'F16', name: 'F-16 Fighting Falcon', category: 'M', approachCategory: 'D', wakeCategory: Wake.MEDIUM, aircraftClass: 'MILITARY', rotorcraft: false,
  ...
  {
    icao: 'H60', name: 'Sikorsky UH-60 Black Hawk', category: 'L', approachCategory: 'C', wakeCategory: Wake.LIGHT, aircraftClass: 'HELICOPTER', rotorcraft: true,
    cruiseSpeed: 150, approachSpeed: 60, rotationSpeed: 0, taxiSpeed: 12,
    climbRate: 1200, descentRate: 1000, serviceCeiling: 19000, minRunwayLengthFt: 0,
  },
  {
    icao: 'EC35', name: 'Eurocopter EC135', category: 'L', approachCategory: 'C', wakeCategory: Wake.LIGHT, aircraftClass: 'HELICOPTER', rotorcraft: true,
    cruiseSpeed: 135, approachSpeed: 55, rotationSpeed: 0, taxiSpeed: 10,
    climbRate: 1400, descentRate: 1100, serviceCeiling: 20000, minRunwayLengthFt: 0,
  },
  {
    icao: 'H125', name: 'Airbus H125', category: 'L', approachCategory: 'C', wakeCategory: Wake.LIGHT, aircraftClass: 'HELICOPTER', rotorcraft: true,
    cruiseSpeed: 120, approachSpeed: 60, rotationSpeed: 0, taxiSpeed: 25,
    climbRate: 1300, descentRate: 1000, serviceCeiling: 23000, minRunwayLengthFt: 0,
  },
  {
    icao: 'H135', name: 'Airbus H135', category: 'L', approachCategory: 'C', wakeCategory: Wake.LIGHT, aircraftClass: 'HELICOPTER', rotorcraft: true,
    cruiseSpeed: 132, approachSpeed: 70, rotationSpeed: 0, taxiSpeed: 25,
    climbRate: 1400, descentRate: 1000, serviceCeiling: 20000, minRunwayLengthFt: 0,
  },
  {
    icao: 'AW139', name: 'Leonardo AW139', category: 'L', approachCategory: 'C', wakeCategory: Wake.LIGHT, aircraftClass: 'HELICOPTER', rotorcraft: true,
    cruiseSpeed: 145, approachSpeed: 80, rotationSpeed: 0, taxiSpeed: 30,
    climbRate: 1600, descentRate: 1200, serviceCeiling: 20000, minRunwayLengthFt: 0,
  },
] as const
